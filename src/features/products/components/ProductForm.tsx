            ...
            <div className="space-y-4">
              ...
              {formValues.discount?.discountType !== 'none' && (
                <FormInput
                  ...
                  placeholder={formValues.discount.discountType === 'percentage' ? '10%' : '10.00'}
                  className="text-sm h-[53px]"
                  type="text"
                  min="0"
                  onInput={(e: React.FormEvent<HTMLInputElement>) => {
              ...
              {showVariants && variants.length > 0 && (
                <div className="space-y-4">
                  {variants.map((variant, variantIndex) => (
                    <Card key={variant.id} className="p-4 border-2 border-gray-200 shadow-md gap-2">
        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              <Button type="button" variant="ghost" onClick={handleBackClick} className="p-1">
                <ChevronLeft className="h-5 w-5" />
              </Button>
              <h2 className="text-lg font-semibold text-gray-900">Marketplace & Delivery</h2>
            </div>
              ...
              <div className="space-y-2 rounded-lg border border-gray-200 p-4">
                ...
                >
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setValue('marketplaceOptions.pickup', checked)}
                ...
                >
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setValue('marketplaceOptions.shipping', checked)}
                    className="h-5 w-5 data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                  />
                  <span className="text-sm font-medium leading-none">
                    Shipping
                ...
                >
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setValue('marketplaceOptions.delivery', checked)}
                    className="h-5 w-5 data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                  />
                  <span className="text-sm font-medium leading-none">
                    Delivery
            ...
            {formValues.marketplaceOptions?.pickup && (
              <div className="mb-4">
                <label className="block mb-2 text-sm font-medium text-gray-900">Pickup Hours</label>
                <PickupHoursSelector
              ...
              <div>
                <div className="relative">
                  <FormInput
                    ...
                    className="border-gray-300 h-[53px] pr-10"
                  />
