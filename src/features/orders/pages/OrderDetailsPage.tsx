    ...
    <div className="py-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className=" space-y-4">
          ...
          <CustomerDetailsSection customerDetails={order.customer} title='Customer Details' reviewTitle='Reviews & Rating From Customer' />
       {order?.driver &&   <CustomerDetailsSection customerDetails={order.driver} title='Assign To' reviewTitle='Reviews & Rating From Driver' />}
