      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-gray-600">
            This page was delayed by 3 seconds using the{' '}
            <code className="bg-gray-100 px-1 rounded">withDelay()</code> utility.
          </p>

          <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
            <h3 className="font-semibold text-green-900 mb-2">Success!</h3>
            <p className="text-sm text-green-800">
              If you saw the red background loader before this page appeared, the lazy loading delay
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-gray-700 mb-2">
              You can add delays to any route by wrapping the import with{' '}
              <code className="bg-gray-100 px-1 rounded">withDelay()</code>:
            </p>
