        ...
        <CardContent className="text-center space-y-6">
          ...
          {showSearch && (
            <div className="space-y-2">
              <p className="text-sm text-gray-500">Try searching for what you're looking for:</p>
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-500">
              ...
              <a href="mailto:support@sourcebuild.com" className="text-primary">
                support@sourcebuild.com
              </a>
            </p>
          </div>
        </CardContent>
