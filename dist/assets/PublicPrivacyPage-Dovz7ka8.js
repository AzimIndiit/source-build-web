import{j as e,S as i}from"./index-CUSVstqU.js";import{u as n,C as s}from"./useCmsMutations-BaHNA7Xh.js";const c=`
...
📞 Phone: +91-XXXXXXXXXX
📍 Address: Source Build, City, State, Country`,m=()=>{const{data:r,isLoading:a,error:t}=n(s.PRIVACY_POLICY),o=r?.data;return a?e.jsx(i,{className:"h-8 w-48 mb-4"}):t?e.jsx("div",{className:"text-red-500",children:"Error loading content"}):e.jsx("div",{className:"min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8",children:e.jsxs("div",{className:" mx-auto bg-white rounded-lg shadow-sm p-6 sm:p-8",children:[e.jsx("h1",{className:"text-2xl sm:text-3xl font-bold text-gray-900 mb-6",children:o?.title||"Privacy Policy"}),e.jsx("div",{className:"prose prose-gray max-w-none",children:e.jsx("div",{className:"text-sm sm:text-base text-gray-600 leading-relaxed whitespace-pre-line",children:o?.content||c})})]})})};export{m as default};
